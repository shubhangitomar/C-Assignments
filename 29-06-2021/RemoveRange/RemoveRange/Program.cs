...
namespace RemoveRange
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //ListCustomer.Remove(customer1);//Remove only one element  
            //ListCustomer.RemoveAt(2);//Remove only one element of specific index
            //ListCustomer.RemoveAll(x => x.Type == "Corporate" );//Remove only one element  
            ListCustomer.RemoveRange(2,2); 
