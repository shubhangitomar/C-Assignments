...
namespace GetRange
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ListCustomer.AddRange(CorporateCustomer);

            //GetRange(Starting index,total number of elements to return)
            List<Customer> GetRange = ListCustomer.GetRange(2, 2);

            foreach (Customer c in GetRange)
            {
